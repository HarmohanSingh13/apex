...
program
    .name('ai-sdlc')
    .description('Enterprise AI-SDLC Framework — install agent skills and workflows into any project')
    .version(pkg.version);
program
    .command('install')
...
// default: run install when no command given (npx github:org/ai-sdlc)
program.action(() => {
